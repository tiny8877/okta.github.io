...
**Details**: Use the below `/userinfo` endpoint, as it returns a well-formatted email for Okta to consume. `https://api.sandbox.paypal.com/v1/identity/openidconnect/userinfo/?schema=openid`<br>
