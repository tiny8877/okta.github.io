...
You can specify whether or not to include custom scopes in the metadata endpoints for [OAuth 2.0](/docs/api/resources/oidc#well-knownoauth-authorization-server) and [OpenID Connect](/docs/api/resources/oauth2#retrieve-authorization-server-openid-connect-metadata).
