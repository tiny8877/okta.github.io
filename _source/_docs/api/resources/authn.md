...
##### Resend SMS Challenge (OTP)

Use the `resend` link to send another OTP if user doesn't receive the SMS Challenge OTP.

###### Request Example for Resend SMS Challenge (OTP)
