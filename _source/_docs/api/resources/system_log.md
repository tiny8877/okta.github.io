...
| core.concurrency.org.limit.violation | An endpoint has exceeded its allotted [concurrency limit](/docs/api/getting_started/rate-limits#concurrent-rate-limits). |
