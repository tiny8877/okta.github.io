...
See [Using Group Functions for Dynamic Group Whitelists](#using-group-functions-for-dynamic-group-whitelists), below for more information about specifying groups with `getFilteredGroups`.
...
#### Using Group Functions for Static Group Whitelists
