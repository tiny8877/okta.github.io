...
See [Using Group Functions for Dynamic Group Whitelists](#using-group-functions-for-dynamic-group-whitelists), above for more information about specifying groups with `getFilteredGroups`.
