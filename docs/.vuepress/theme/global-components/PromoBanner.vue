...
<script>
  ...
  export default {
    ...
    data() {
      ...
      return {
        show: false,
        promo_url: 'http://developer.okta.com',
        promo_text: '',
        cta_text: '',
      }
