  ...
  computed: {
    ...
    activeClientComponent: function () {
      let component = this.$site.pages.find((page) => {
        return page.path.startsWith('/quickstart-fragments/'+this.activeClient+'/default-example')
      })
